...
# camera.start_recording('/home/pi/droide/video.h264')
# time.sleep(5)
...
class WSHandler(tornado.websocket.WebSocketHandler):
    ...
    def on_message(self, message):  # receives the data from the webpage and is stored in the variable message
        ...
        if c == '8':
            ...
            BrickPi.MotorSpeed[PORT_B] = 255  # Set the speed of MotorD (-255 to 255)
        elif c == '2':
...
def start_rpi_server():
    call_script_as_process("droid_remote_control/RPi_Server_Code.py")
